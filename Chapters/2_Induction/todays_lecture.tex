...
\begin{boxexample}[Sequences of Ordinals]
    ...
    Let's consider $[\OR]^{< \omega}$. Say $s \in [\OR]^{< \omega}$. Say $n < \omega$ and $s \in [\OR]^{n}$. List $s$ in decreasing order as $s_0 > s_1 > \cdots > s_{n - 1}$, where $s = \emptyset$ if $n = 0$. Identify $s$ with the $n$-tuple $\parenth{s_0, \ldots, s_{n-1}}$. Let $<_{\lex}$ denote the lexicographic ordering on members of $[\OR]^{< \omega}$ under this identification. We see that
    \begin{itemize}
