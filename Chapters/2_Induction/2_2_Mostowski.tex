...
\begin{enumerate}
    ...
    % [IGNORE] Author's instruction (10 Sep 2026): leave this \sorry as it is. /fill-sorries, /post-lecture and every other skill skip it; the next lecture's raw notes are expected to replace it.
