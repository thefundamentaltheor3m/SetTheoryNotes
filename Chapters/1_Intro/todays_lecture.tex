...
\begin{proof}
    ...
    By \sorry(cross-ref), since $A$ is transitive and $(A, \in)$ is well-founded, by our assumption $(2)$, we get that $A \in \WF$. So $x \in A \subset \WF$. Thus, $x \in \WF$.
\end{proof}
