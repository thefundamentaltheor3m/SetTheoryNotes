...
\begin{align*}
% [CORRECTED] was: $\setst{R \ssq \kappa}{\parenth{\kappa, R} \text{ is a well-ordering}}$ --- $R$ has to be a relation on $\kappa$ for $\parenth{\kappa, R}$ to be a structure, and no subset of $\kappa$ is a set of ordered pairs, so as written the displayed class was empty
