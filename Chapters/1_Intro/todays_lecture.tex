...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \item \underline{\textbf{Existence.}}
            We'll show that for all $z \in A$, there is some approximation $g_z$ with $\dom{g_z}$ being the $R$-closure of $z$. These $g_z$, if we can show them to exist, are unique (by above).
