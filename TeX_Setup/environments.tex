...
% \newcounter{ZFC}
% \setcounter{ZFC}{0}
\newtheorem{zfcaxiom}{ZFC Axiom}
\crefname{zfcaxiom}{ZFC Axiom}{ZFC Axioms}
\Crefname{zfcaxiom}{ZFC Axiom}{ZFC Axioms}
\newenvironment{baxiom}{
    \begin{tcolorbox}[colback=cyan!10!white,colframe=cyan!70!black, breakable, enhanced]\begin{zfcaxiom}
}{
    \end{zfcaxiom}\end{tcolorbox}
    % \addtocounter{ZF}{1}
}
