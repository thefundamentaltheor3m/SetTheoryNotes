...
\newcommand{\dom}[1]{\operatorname{dom}\of{#1}} % Domain
\newcommand{\ran}[1]{\operatorname{ran}\of{#1}} % Range
...
% IMPERIAL LOGIC NOTES SHORTCUTS
...
\newcommand{\ZFCwoF}{\ZFC - \mathbf{F}}
\newcommand{\ZFwoF}{\ZF - \mathbf{F}}
...
\newcommand{\UR}{\mathbf{UR}}
\newcommand{\V}{\mathbf{V}}

\newcommand{\trcl}[1]{\operatorname{trcl}\!\parenth{#1}} % Transitive closure

\newcommand{\cf}[1]{\operatorname{cf}\!\parenth{#1}} % Cofinality

\newcommand{\lex}{\operatorname{lex}} % lexicographic (eg. ordering)

\renewcommand{\models}{\vDash}

\newcommand{\symdiff}{\, \triangle \,}
\newcommand{\symmdiff}{\symdiff}
